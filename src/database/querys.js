export const querys = {
  ...
  */
  ...
  getDetalleSolicitudAdmin: "SELECT S.Codigo,S.DetalleSolicitud,S.FechaRegistro,S.IdUsuario,DS.IdUsuario AS Responsable,U.nombre,T.Tipo,E.Estado FROM DetalleSolicitud AS DS inner join Solicitud as S on DS.IdSolicitud=S.IdSolicitud INNER JOIN Usuario as U ON S.IdUsuario=U.IdUsuario INNER JOIN Tipo AS T ON DS.IdTipoSolicitud=T.IdTipoSolicitud INNER JOIN Estado as E ON DS.IdEstadoSolicitud=E.IdEstadoSolicitud",
